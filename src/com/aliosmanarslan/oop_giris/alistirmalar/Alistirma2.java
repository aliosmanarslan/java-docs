 ...
 * Description: Ogrenci isimli sınıf oluşturun. Bu sınıfta ogrencinin idsi ve not değeri tutulmalı.
 * 100 elemanlı bir dizide id ve not değerlerini rastgele olusturarak bu ogrencileri saklayın ve bu
 * ogrencileri aldıkları notlara göre azalan sırada yazdıran metotu yazın.
 */
